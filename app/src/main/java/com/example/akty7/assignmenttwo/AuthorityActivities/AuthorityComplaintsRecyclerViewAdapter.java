...
public class AuthorityComplaintsRecyclerViewAdapter extends RecyclerView.Adapter<AuthorityComplaintsRecyclerViewAdapter.DataObjectHolder>{

    ArrayList<Complaint> mDataset;
    JSONParser jp;
    Context context;
    public AuthorityComplaintsRecyclerViewAdapter(ArrayList<Complaint> usercomps) {
