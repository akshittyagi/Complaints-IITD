...
public class UsersRecyclerViewAdapter extends RecyclerView.Adapter<UsersRecyclerViewAdapter.DataObjectHolder>{

    ArrayList<Complaint> mDataset;
    JSONParser jp;
    Context context;
    public UsersRecyclerViewAdapter(ArrayList<Complaint> usercomps) {
